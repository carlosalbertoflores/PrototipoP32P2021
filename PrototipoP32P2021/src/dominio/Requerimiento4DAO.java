...
public class Requerimiento4DAO {
   private static final String SQL_SELECT = "SELECT ID, Nombre, Apellido, DPI, Tipo, Genero, FechaAlquiler, FechaCaducidad, FechaTarde, ImporteCargo, Total FROM tbl_registrosatrasados";
...
// private static final String SQL_UPDATE = "UPDATE tbl_proveedor SET   nombre_proveedor= ?, direccion_proveedor= ?, contacto_proveedor= ?, telefono_proveedor= ?, nit_proveedor= ?,  email_proveedor= ?, estatus_proveedor= ?    WHERE PK_id_proveedor= ?";
 ...
 private static final String SQL_QUERY = "SELECT  ID, Nombre, Apellido, DPI, Tipo, Genero, FechaAlquiler, FechaCaducidad, FechaTarde, ImporteCargo, Total FROM tbl_registrosatrasados WHERE ID= ?";
